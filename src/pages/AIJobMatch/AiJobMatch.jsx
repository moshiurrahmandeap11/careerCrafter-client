                        ...
                        <div className="bg-white rounded-lg border border-gray-300 overflow-hidden">
                            ...
                            <div className="p-4">
                                <div className="space-y-2 mb-4">
                                    ...
                                    <ProfileItem label="Location" value={userProfile?.preferredLocation || 'Not specified'} />
                                    <ProfileItem label="Expected Salary" value={`$${userProfile?.expectedSalary || '0'}/month`} />
                                </div>
                                ...
                                {getUserSkills().length > 0 && (
                                    <div className="mb-4">
                                        ...
                                        <div className="flex flex-wrap gap-1">
                                            {getUserSkills().slice(0, 6).map((skill, index) => (
                                                <span 
                                                    key={index}
...
const ProfileOverviewTab = () => (
    <div className="space-y-6">
        <div>
            <h3 className="text-xl font-bold text-gray-900 mb-3">Welcome to Job Matching</h3>
            <p className="text-gray-600 text-sm">
                Our system will analyze your profile and find suitable jobs for you. Click "Find Matches" to get started!
            </p>
        </div>
    ...
    <div className="space-y-4">
        ...
        {loading ? (
            <div className="text-center py-8">
                <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto mb-4"></div>
                <h3 className="text-lg font-bold text-gray-900 mb-2">Analyzing Your Profile</h3>
                <p className="text-gray-600 text-sm">Finding the best opportunities...</p>
            </div>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 bg-blue-50 p-4 rounded-lg border border-blue-200">
                    <div>
                        <h3 className="text-lg font-bold text-gray-900 mb-1">
                            Found {matchedJobs.length} Job {matchedJobs.length === 1 ? 'Match' : 'Matches'}
                        </h3>
                        <p className="text-gray-600 text-sm">Sorted by compatibility score</p>
                    </div>
                    <button
                        onClick={handleJobMatch}
                        ...
                        >
                            ...
                            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-4 gap-3">
                                ...
                                <div className="flex flex-col items-center gap-1">
                                    <div className={`${getScoreColor(match.matchScore)} text-white px-4 py-2 rounded-lg font-bold text-lg`}>
                                        {match.matchScore}%
                                    </div>
                            ...
                            {job.requiredSkills && job.requiredSkills.length > 0 && (
                                <div className="mb-4">
                                    <h4 className="font-bold text-gray-900 mb-2 text-sm">Required Skills</h4>
                                    <div className="flex flex-wrap gap-1">
            ...
            <div className="text-center py-8">
                ...
                <p className="text-gray-600 text-sm mb-6 max-w-md mx-auto">
                    Click the "Find Matches" button to start discovering jobs that match your profile.
                </p>
                <button
                    onClick={handleJobMatch}
