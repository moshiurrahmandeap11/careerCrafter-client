                ...
                <div className="space-y-6">
                    {feedItems.length === 0 ? (
                        ...
                        feedItems.map((item, index) => (
                            <div key={index} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-all duration-200">
                                {/* Job Post */}
                                {item.type === 'job_post' && (
                                    <div className="p-6">
                                        <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="flex flex-wrap gap-2 mt-4">
                                                    <button onClick={() => navigate(`/job/${item._id}`)} className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-xl font-medium text-sm transition-all duration-200 flex items-center space-x-2">
                                                        <Briefcase className="w-4 h-4" />
                                                        <span>Apply Now</span>
                                                    </button>
                                                    <button onClick={() => navigate(`/job/${item._id}`)} className="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-xl font-medium text-sm transition-all duration-200 flex items-center space-x-2">
                                ...
                                {item.type === 'hired_post' && (
                                    <div className="p-6">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                                    {item.profileData.desiredJobTitle && (
                                                        <div className="flex items-center space-x-2">
                                                            ...
                                                            <span className="text-gray-700">
                                                                <strong>Desired Role:</strong> {item.profileData.desiredJobTitle}
                                                            </span>
                                                        </div>
                                                    )}
                                                    ...
                                                    {item.profileData.currentJobTitle && (
                                                        <div className="flex items-center space-x-2">
                                                            ...
                                                            <span className="text-gray-700">
                                                                <strong>Current Role:</strong> {item.profileData.currentJobTitle}
                                                            </span>
                                                        </div>
                                                    )}
                                                    ...
                                                    {item.profileData.location && (
                                                        <div className="flex items-center space-x-2">
                                                            ...
                                                            <span className="text-gray-700">
                                                                <strong>Location:</strong> {item.profileData.location}
                                                            </span>
                                                        </div>
                                                    )}
                                                    ...
                                                    {item.profileData.expectedSalary && (
                                                        <div className="flex items-center space-x-2">
                                                            <DollarSign className="w-4 h-4 text-green-600" />
                                                            <span className="text-gray-700">
                                                                <strong>Expected Salary:</strong> ${item.profileData.expectedSalary}
                                                            </span>
                                                        </div>
                                                    )}
                                                    ...
                                                    {item.profileData.yearsOfExperience && (
                                                        <div className="flex items-center space-x-2">
                                                            ...
                                                            <span className="text-gray-700">
                                                                <strong>Experience:</strong> {item.profileData.yearsOfExperience}
                                                            </span>
                                                        </div>
                                                    )}
                                                    ...
                                                    {item.profileData.preferredJobType && (
                                                        <div className="flex items-center space-x-2">
                                                            ...
                                                            <span className="text-gray-700">
                                                                <strong>Job Type:</strong> {item.profileData.preferredJobType}
                                                            </span>
                                                        </div>
                                                    )}
                                                </div>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            ...
                                            <button className="bg-gray-100 hover:bg-gray-200 text-gray-700 px-4 py-2 rounded-xl font-medium text-sm transition-all duration-200 flex items-center space-x-2">
                                                <Eye className="w-4 h-4" />
