...
export const ConversationItem = ({ conversation, isSelected, onClick }) => (
    <motion.div
        ...
        className={`p-4 border-b border-gray-100 cursor-pointer transition-all duration-200 group ${isSelected ? 'bg-blue-50 border-l-4 border-l-blue-500' : 'hover:bg-gray-50'
            }`}
        onClick={onClick}
    >
