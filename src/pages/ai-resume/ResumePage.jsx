...
import { Sparkles, Edit3, BarChart3 } from "lucide-react";
...
const ResumePage = () => {
        ...
        setSuggestions([
          {
            ...
            description:
              'Add industry-specific keywords like "React", "Node.js", "AWS" to improve ATS matching.',
            impact: "high",
          },
          {
            type: "warning",
            ...
            description:
              'Use standard section headers: "Work Experience" instead of "Professional Journey".',
            impact: "medium",
          },
          {
            type: "success",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      <Helmet>
        <title>
          Free AI Resume Builder - Create Professional Resume in Minutes
        </title>
        <meta
          name="description"
          content="Build a professional resume with our free AI-powered resume builder. Get ATS-friendly templates, instant feedback, and download in PDF format."
        />
        <meta
          name="keywords"
          content="AI resume builder, free resume maker, professional resume, ATS resume, CV builder, resume templates"
        />
        <link
          rel="canonical"
          href="https://careercrafter.moshiurrahman.online/ai-resume-builder"
        />
      </Helmet>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Create ATS-friendly resumes or optimize your existing one with
            AI-powered suggestions and scoring.
          </p>
        </motion.div>
