...
import { Download, Eye, FileText, Plus, Trash2, Briefcase, GraduationCap, User, Mail, Phone, MapPin, Globe, Github, ExternalLink, Menu, X } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg border border-gray-300 p-4">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Resume Actions</h3>
              <div className="space-y-3">
                <button
                ...
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-300 min-h-[400px] text-sm">
                  <div className="space-y-3">
                    ...
                    <div className="text-center border-b pb-3">
                      <h2 className="text-xl font-bold text-gray-900">{resumeData.personal.name || "Your Name"}</h2>
                      <p className="text-gray-600">{resumeData.personal.title || "Professional Title"}</p>
                    </div>

                    {/* Contact Information */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      <div><strong>Email:</strong> {resumeData.personal.email || "your.email@example.com"}</div>
                      <div><strong>Phone:</strong> {resumeData.personal.phone || "+1234567890"}</div>
                      <div><strong>Location:</strong> {resumeData.personal.location || "Your Location"}</div>
                      {resumeData.personal.website && <div><strong>Website:</strong> {resumeData.personal.website}</div>}
                    </div>

                    {/* Career Objective */}
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-1">Career Objective</h3>
                      <p className="text-gray-600">{resumeData.personal.summary || "Your career objective..."}</p>
                    </div>
                      ...
                      <div>
                        ...
                        {resumeData.projects.map((project, index) => (
                          <div key={index} className="mb-2">
                            ...
                            <p className="text-gray-600 text-xs">Tech: {project.technologies || "Technologies"}</p>
                          </div>
                        ))}
                      </div>
                    )}
