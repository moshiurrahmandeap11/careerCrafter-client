  ...
  const renderContent = () => {
    switch(activeRoute) {
        ...
        return (
          <div>
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-500">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <h3 className="text-3xl font-bold text-slate-800 mt-2">12,458</h3>
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-purple-500">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <h3 className="text-3xl font-bold text-slate-800 mt-2">3,241</h3>
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <h3 className="text-3xl font-bold text-slate-800 mt-2">8,392</h3>
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-orange-500">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <h3 className="text-3xl font-bold text-slate-800 mt-2">87%</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                <h3 className="text-xl font-bold text-slate-800 mb-4">Popular Jobs</h3>
                <div className="space-y-4">
                  {['Senior Developer', 'UI/UX Designer', 'Product Manager', 'Data Analyst'].map((job, i) => (
                    <div key={i} className="flex items-center justify-between pb-4 border-b border-slate-100 last:border-0">
                      <div>
                        ...
                        <p className="text-sm text-slate-500">{Math.floor(Math.random() * 100) + 50} applications</p>
                      </div>
      ...
      case 'users':
        return (
          <div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              <p className="text-slate-600">Manage all registered users, view their profiles, and monitor activity.</p>
            </div>
          </div>
        );
      ...
      case 'jobs':
        return (
          <div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              <p className="text-slate-600">Create, edit, and manage job postings across the platform.</p>
            </div>
          </div>
        );
      ...
      case 'applications':
        return (
          <div>
            <h1 className="text-3xl font-bold text-slate-800 mb-6">Applications</h1>
            <div className="bg-white rounded-xl shadow-md p-6">
              <p className="text-slate-600">Track and manage all job applications submitted by users.</p>
            </div>
          </div>
        );
      ...
      case 'analytics':
        return (
          <div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              <p className="text-slate-600">View detailed analytics and reports on platform performance.</p>
            </div>
          </div>
        );
      ...
      case 'messages':
        return (
          <div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              <p className="text-slate-600">Communicate with users and manage support tickets.</p>
            </div>
          </div>
        );
      ...
      case 'site-settings':
        return (
          <div>
            <h1 className="text-3xl font-bold text-slate-800 mb-6">Site Settings Settings</h1>
            <div className="bg-white rounded-xl shadow-md p-6">
